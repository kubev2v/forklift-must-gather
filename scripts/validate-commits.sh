...
print_detailed_error() {
  ...
  case "$error_type" in
    ...
    echo "   • Resolves: MTV-<num1> MTV-<num2>  (space-separated)"
    echo "   • Resolves: MTV-<num1>, MTV-<num2>  (comma-separated)"
    echo "   • Resolves: MTV-<num1> and MTV-<num2>  (and-separated)"
    echo "   • Resolves: None  (if no ticket is associated)"
    echo "   Note: Do not mix different separators in the same line"
      echo ""
